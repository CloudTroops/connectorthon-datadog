module.exports = {
    ...
    input: 
        { title: "Input", type: "object",properties: {"from": { "title":"from","type": "integer",},} },
    ...
    execute: function(input, output) {
        ...
        var option = {
            ...
            "json": input.payload,            "url": global_constants.get_uri(input.auth.site,api_domain)+"/api/v1/hosts/totals",
			"qs":{ from: input.from }
        }
