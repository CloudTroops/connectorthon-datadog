module.exports = {
  ...
  "name": "example user"
    ...
    input: 
        { title: "Input", type: "object",properties: {"payload": { "title":"payload","type": "object", "properties": {"name": { "title":"name","type": "string",},} },} },
    ...
    execute: function(input, output) {
        ...
        var option = {
            ...
            "json": input.payload,            "url": global_constants.get_uri(input.auth.site,api_domain)+"/api/v1/application_key",
			"qs":{   }
        }
